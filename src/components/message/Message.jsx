...
export default function Message({messageOpen, setMessageOpen}) {
    // set Name
    ...
    return (
        < >
        <div onload={onStartMessage} className={"message " + (messageOpen && "active")} onClick = {onStartMessage}>
        ...
        <div className={"messageBox " + (messageOpen && "active")}>
            ...
            <textarea className="messageText" rows="6" onChange = {onChangeTxt} value= {messageTxt}>{messageTxt}</textarea>
